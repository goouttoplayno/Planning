...
import static com.example.nationstyle.FlipRenderer.checkError;
import static com.example.nationstyle.TextureUtils.d2r;
import static com.example.nationstyle.TextureUtils.isValidTexture;
import static com.example.nationstyle.TextureUtils.toFloatBuffer;
import static com.example.nationstyle.TextureUtils.toShortBuffer;
...
public class Card {
	...
	public void draw(GL10 gl) {
		...
		if (angle > 0) {
			...
			if (axis == AXIS_TOP) {
				if (orientationVertical) {
					h = (float) ((cardVertices[Y_00] - cardVertices[Y_01])
												* (1.0f - cos(d2r(angle))));
					z = (float) ((cardVertices[Y_00] - cardVertices[Y_01])
												* sin(d2r(angle)));
					...
					w = (float) ((cardVertices[X_10] - cardVertices[X_00])
												* (1.0f - cos(d2r(angle))));
					z = (float) ((cardVertices[X_10] - cardVertices[X_00])
												* sin(d2r(angle)));
